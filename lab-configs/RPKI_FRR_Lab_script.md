...
ipv6 route ::/0 fdfb:b42e::1
!
interface eth0
 description "class backbone"
 ip address 100.64.0.10/22
 ipv6 address fdfb:b42e::10/48
!
interface wg0
...
router bgp 65000
 ...
 neighbor fdfb:b42e:0:1::1 remote-as 65001
 neighbor fdfb:b42e:0:1::1 description grp1-rtr
 neighbor fdfb:b42e:0:1::2 remote-as 65002
 neighbor fdfb:b42e:0:1::2 description grp2-rtr
 neighbor fdfb:b42e:0:1::3 remote-as 65003
 neighbor fdfb:b42e:0:1::3 description grp3-rtr
 ...
 !
 ...
 address-family ipv6 unicast
  ...
  neighbor 172.30.0.1 route-map PERMIT-SOME-ASN in
  neighbor 172.30.0.1 route-map NADA-IPv4 out
  neighbor fdfb:b42e:0:1::1 activate
  neighbor fdfb:b42e:0:1::1 soft-reconfiguration inbound
  neighbor fdfb:b42e:0:1::1 route-map TODO-IPv6 in
  neighbor fdfb:b42e:0:1::1 route-map TODO-IPv6 out
  neighbor fdfb:b42e:0:1::2 activate
  neighbor fdfb:b42e:0:1::2 soft-reconfiguration inbound
  neighbor fdfb:b42e:0:1::2 route-map TODO-IPv6 in
  neighbor fdfb:b42e:0:1::2 route-map TODO-IPv6 out
  neighbor fdfb:b42e:0:1::3 activate
  neighbor fdfb:b42e:0:1::3 soft-reconfiguration inbound
  neighbor fdfb:b42e:0:1::3 route-map TODO-IPv6 in
  neighbor fdfb:b42e:0:1::3 route-map TODO-IPv6 out
  ...
 exit-address-family
!
...
interface eth0
 ...
 ipv6 address fdfb:b42e:0:1::X/48
!
interface eth1
 description "lan"
 ip address 100.100.X.1/26
 ipv6 address fdfb:b42e:X::1/64
!
interface eth2
 description "int"
 ip address 100.100.X.65/26
 ipv6 address fdfb:b42e:X:64::1/64
!
interface eth3
 description "dmz"
 ip address 100.100.X.129/26
 ipv6 address fdfb:b42e:X:128::1/64
!
interface eth4
 description "extra"
 ip address 100.100.X.193/26
 ipv6 address fdfb:b42e:X:192::1/64
!
line vty
!
end
...
Paths: (1 available, best #1, table default)
  ...
  fdfb:b42e::10
  65000 64135
    fdfb:b42e::10 from fdfb:b42e::10 (100.64.0.10)
...
cli.grpX.lac.te-labs.training (fdfb:b42e:X::2)                 2021-10-04T22:06:48+0000
Keys:  Help   Display mode   Restart statistics   Order of fields   quit
                                               Packets               Pings
 Host                                        Loss%   Snt   Last   Avg  Best  Wrst StDev
 1. fdfb:b42e:1::1                            0.0%    10    0.1   0.1   0.1   0.1   0.0
 2. fdfb:b42e::10                             0.0%    10    0.1   0.1   0.1   0.2   0.0
 3. fdfb:b42e::1                              0.0%    10    0.1   0.1   0.1   0.1   0.0
 4. (waiting for reply)
 5. (waiting for reply)
 6. (waiting for reply)
...
```
cli.grpX.lac.te-labs.training (fdfb:b42e:X::2)                 2021-10-04T22:25:36+0000
Keys:  Help   Display mode   Restart statistics   Order of fields   quit
                                               Packets               Pings
 Host                                        Loss%   Snt   Last   Avg  Best  Wrst StDev
 1. fdfb:b42e:1::1                            0.0%   131    0.2   0.1   0.1   0.2   0.0
 2. fdfb:b42e::10                             0.0%   130    0.2   0.1   0.1   0.2   0.1
...
Paths: (1 available, best #1, table default)
  Advertised to non peer-group peers:
  fdfb:b42e:0:1::1 fdfb:b42e:0:1::2 fdfb:b42e:0:1::3 fdfb:b42e:0:1::4 fdfb:b42e:0:1::5
  65000 65002
    fdfb:b42e:0:1::2 from fdfb:b42e:0:1::2 (100.64.1.2)
...
grpX-rtr(config-router-af)# neighbor fdfb:b42e::10 route-map RPKI in
```
...
```
cli.grpX.lac.te-labs.training (fdfb:b42e:X::2)                 2021-10-04T22:50:51+0000
Keys:  Help   Display mode   Restart statistics   Order of fields   quit
                                               Packets               Pings
 Host                                        Loss%   Snt   Last   Avg  Best  Wrst StDev
 1. fdfb:b42e:1::1                            0.0%     8    0.1   0.1   0.1   0.2   0.0
 2. fdfb:b42e::10                      				0.0%     8    0.2   0.1   0.1   0.2   0.0
...
```
cli.grpX.lac.te-labs.training (fdfb:b42e:X::2)                 2021-10-04T23:09:10+0000
Keys:  Help   Display mode   Restart statistics   Order of fields   quit
                                               Packets               Pings
 Host                                        Loss%   Snt   Last   Avg  Best  Wrst StDev
 1. fdfb:b42e:1::1                            0.0%    20    0.1   0.1   0.1   0.1   0.0
 2. fdfb:b42e::10                             0.0%    20    0.1   0.1   0.1   0.1   0.0
 3. fdfb:b42e::1                              0.0%    20    0.1   0.1   0.1   0.2   0.0
 4. (waiting for reply)
 5. (waiting for reply)
 6. (waiting for reply)
...
```
cli.grpX.lac.te-labs.training (fdfb:b42e:X::2)                 2026-05-25T15:02:47+0000
Keys:  Help   Display mode   Restart statistics   Order of fields   quit
                                               Packets               Pings
 Host                                        Loss%   Snt   Last   Avg  Best  Wrst StDev
 1. fdfb:b42e:X::1                           	0.0%     6    0.2   0.2   0.1   0.2   0.0
 2. fdfb:b42e::10                            	0.0%     6    0.2   0.2   0.2   0.2   0.0
...
Paths: (1 available, best #1, table default)
  ...
  fdfb:b42e::10
  65000 65002
    fdfb:b42e:0:1::2 from fdfb:b42e::10 (100.64.0.10)
...
```
router bgp 650XX
 neighbor fdfb:b42e:0:1::5 remote-as 65005
 neighbor fdfb:b42e:0:1::5 description servidor-de-bogons
 address-family ipv6 unicast
  neighbor fdfb:b42e:0:1::5 activate
  neighbor fdfb:b42e:0:1::5 soft-reconfiguration inbound
  neighbor fdfb:b42e:0:1::5 route-map TODO-IPv6 in
  neighbor fdfb:b42e:0:1::5 route-map NADA-IPv6 out
 exit-address-family
```
...
router bgp 650XX
 address-family ipv6 unicast
  neighbor fdfb:b42e:0:1::5 route-map RM-PEER-V6-IN in
